...
Gem::Specification.new do |spec|
  ...
  spec.authors     = ["Nathan Sutton", "Brandon Arbini", "Kamil Kieliszczyk", "Rafi Khan"]
  spec.email       = ["nate@zencoder.com", "brandon@zencoder.com", "kamil@kieliszczyk.net", "rafi@ixperience.co.za"]
  spec.homepage    = "http://github.com/iExperience/forgery"
